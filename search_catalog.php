            ...
            <div class="row">
                <div class="col-12">
                    <div class="header__search-content">
                        ...
                        <div>
                            <input class="sign__btn" name="submit" type="submit"  value="submit">
                        </div>
                    </div>
                </div>
            </div>
...
<div class="catalog" style="margin-top: 40px;">
    <div class="container">
        <h2 class="section__title">Find Moives</h2>
        <div class="col-12" style="padding-left: 0 !important">
            <div style="display:flex;flex-wrap: wrap">
                ...
                if (isset($_POST['submit'])){
                    require "config.php";
                    $search = $_POST['search'];
                    $sql = "SELECT * FROM `film` WHERE name LIKE '%$search%'";
                    $res = mysqli_query($con, $sql);
                    $count = mysqli_num_rows($res);

                    if($search == "Search for a movie, TV Series that you are looking for"){
                    ...
                    if ($count > 0) {
                        while ($row = mysqli_fetch_assoc($res)) {
                            ...
                            ?>
                            <div class="col-6 col-sm-4 col-lg-3 col-xl-2" style="padding-left: 0 !important; padding-right: 0 !important;">
                                <div class="card">
                                    <div class="card__cover">
                                        <img src="<?=$photos?>" height="240" alt="">
                                        <a href="details1.php?id=<?=$id?>" class="card__play">
                                            <i class="icon ion-ios-play"></i>
                                        </a>
                                    </div>
                                    <div class="card__content">
                                        <h3 class="card__title"><a href="details1.php?id=<?=$row["id"]?>"><?=$name?></a></h3>
